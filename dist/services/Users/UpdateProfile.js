...
let UpdateProfile = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (checkUsersExists && checkUsersExists.id) if (checkUsersExists && Number(user_id) !== checkUsersExists.id) {
